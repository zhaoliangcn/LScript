...
void COutputWnd::UpdateBuildOutput()
{
}

void COutputWnd::UpdateDebugOutput(const wchar_t * output)
{
	while(m_wndOutputDebug.GetCount()>0)
		m_wndOutputDebug.DeleteString(0);
	m_wndOutputDebug.AddString(output);
}
void  COutputWnd::AppendDebugOutput(const wchar_t * output)
{
	m_wndOutputDebug.AddString(output);
}
void COutputWnd::ClearDebugOutput()
{
	while (m_wndOutputDebug.GetCount() > 0)
		m_wndOutputDebug.DeleteString(0);
}
